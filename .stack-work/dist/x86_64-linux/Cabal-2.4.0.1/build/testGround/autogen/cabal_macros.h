...
/* package testGround-0.1.0.0 */
#ifndef VERSION_testGround
#define VERSION_testGround "0.1.0.0"
#endif /* VERSION_testGround */
#ifndef MIN_VERSION_testGround
#define MIN_VERSION_testGround(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_testGround */
...
#define CURRENT_COMPONENT_ID "testGround-0.1.0.0-8R0xaYdZvMz1lB6KuezxXd-testGround"
